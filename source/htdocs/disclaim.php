 ...
 *
 * purpose: define the disclaimer clients must agree to.
 * this one stolen from http://wiki.personaltelco.net/index.cgi/ \
 * AcceptableUsePolicy
 * 
 *
